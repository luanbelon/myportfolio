...
const translations = {
  ...
  coletafacil: 'Portfolio Criativo',
  coletafacilDesc: 'Site portfolio para artista com galeria interativa.',
  ...
  en: {
    ...
    coletafacil: 'Creative Portfolio',
    coletafacilDesc: 'Portfolio website for artist with interactive gallery.',
  ...
  es: {
    ...
    coletafacil: 'Portfolio Creativo',
    coletafacilDesc: 'Sitio web portfolio para artista con galería interactiva.',
