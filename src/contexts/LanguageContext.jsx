...
const translations = {
  pt: {
    ...
    resumeMetaDescription: 'Currículo de Luan Belon — engenheiro frontend pleno e UX/UI no Brasil, disponível para remoto e freelance. Experiência em Angular, React, WordPress e Figma.',
  ...
  en: {
    ...
    resumeMetaDescription: 'Resume of Luan Belon — mid-level frontend engineer and UX/UI designer in Brazil, available for remote work and freelance. Angular, React, WordPress and Figma.',
  ...
  es: {
    ...
    languageLabel: 'Idioma',
    resumeMetaDescription: 'Currículo de Luan Belon — ingeniero frontend pleno y UX/UI en Brasil, disponible para remoto y freelance. Angular, React, WordPress y Figma.',
  ...
  de: {
    ...
    resumeMetaDescription: 'Lebenslauf von Luan Belon — Frontend-Ingenieur und UX/UI Designer in Brasilien, verfügbar für Remote-Arbeit und Freelance. Angular, React, WordPress und Figma.',
