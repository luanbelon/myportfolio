...
const translations = {
  pt: {
    ...
    scrollPageHint: 'Role ou arraste para ver a página completa',
  ...
  en: {
    ...
    scrollPageHint: 'Scroll or drag to see the full page',
  ...
  es: {
    ...
    scrollPageHint: 'Desplaza o arrastra para ver la página completa',
  ...
  de: {
    ...
    scrollPageHint: 'Scrollen oder ziehen, um die ganze Seite zu sehen',
